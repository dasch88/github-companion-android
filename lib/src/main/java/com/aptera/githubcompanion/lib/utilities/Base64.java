...
//this is included here since this is a separate java library, but there isn't really a good
//way to encode/decode base64 inside android that is native java that i could find. this avoids
//us from having to reference the android assemblies, which is the entire goal of having this
//separate library
